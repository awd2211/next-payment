...
type TwoFactorAuth struct {
	...
	MerchantID uuid.UUID  `gorm:"type:uuid;not null;uniqueIndex" json:"merchant_id"`      // 商户ID
...
func (TwoFactorAuth) TableName() string {
	return "merchant_two_factor_auth"
}
...
func (LoginActivity) TableName() string {
	return "merchant_login_activities"
}
...
func (SecuritySettings) TableName() string {
	return "merchant_security_settings"
}
...
func (PasswordHistory) TableName() string {
	return "merchant_password_history"
}
