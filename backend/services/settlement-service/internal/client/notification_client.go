...
type SendNotificationRequest struct {
	...
	Type        string                 `json:"type"` // settlement_complete, settlement_failed, withdrawal_complete
...
// SendSettlementNotification 发送结算相关通知
func (c *NotificationClient) SendSettlementNotification(ctx context.Context, req *SendNotificationRequest) error {
	// 构建URL
